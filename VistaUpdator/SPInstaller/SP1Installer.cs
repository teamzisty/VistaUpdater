...
{
    public partial class SP1Installer : Form
    {
        public SP1Installer()
        {
            InitializeComponent();
        ...
        private void SP1Installer_Load(object sender, EventArgs e)
        {
            ...
            listBox1.Items.Add("Windows Vista Service Pack 1 をダウンロードしています...");
        ...
        private void Wc1_DownloadFileCompleted(object sender, AsyncCompletedEventArgs e)
        {
            ...
            ChangeInstallState("Service Pack 1 をインストールしています...", 50);
            System.Diagnostics.Process process = new System.Diagnostics.Process();
            process.StartInfo.FileName = "C:\\Program Files\\VistaUpdater\\Update\\sp1.exe";
        ...
        private void Process_Exited(object sender, EventArgs e)
        {
            ...
            regkey1.SetValue("SP1Installed", 1, Microsoft.Win32.RegistryValueKind.QWord);
            regkey1.Close();
