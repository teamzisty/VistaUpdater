...
namespace Win7Updater
{
    public partial class RestartedUpdate : Form
    {
        ...
        private void StartUpdate_Load(object sender, EventArgs e)
        {
            ...
            listBox1.Items.Add("Windows 7 for x64-Based Systems 用更新プログラム (KB3125574) をダウンロードしています...");
        }
        ...
        private void p_Exited(object sender, EventArgs e)
        {
            ...
            p.StartInfo.Arguments = "/r /t 10 /c \"Win7Updater の処理を完了するため、10秒後に再起動します。\"";
            p.Start();
        }
        ...
        private void Wc1_DownloadFileCompleted(object sender, AsyncCompletedEventArgs e)
        {
            ...
            else
            {
                ...
                p.Exited += p_Exited;
                listBox1.Items.Add("Windows 7 for x64-Based Systems 用更新プログラム (KB3125574) をインストールしています...");
